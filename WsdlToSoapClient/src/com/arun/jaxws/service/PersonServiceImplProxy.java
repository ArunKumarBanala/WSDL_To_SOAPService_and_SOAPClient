...
public class PersonServiceImplProxy implements com.arun.jaxws.service.PersonServiceImpl {
  private String _endpoint = null;
  private com.arun.jaxws.service.PersonServiceImpl personServiceImpl = null;
  ...
  private void _initPersonServiceImplProxy() {
    try {
      personServiceImpl = (new com.arun.jaxws.service.PersonServiceImplServiceLocator()).getPersonServiceImpl();
  ...
  public com.arun.jaxws.service.PersonServiceImpl getPersonServiceImpl() {
    if (personServiceImpl == null)
      _initPersonServiceImplProxy();
